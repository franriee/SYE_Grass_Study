...
```{r tbl-gradientstats, echo=FALSE, warning=FALSE, message=FALSE}
library(knitr)
library(kableExtra)
library(readr)
library(tidyverse)
...
```
```{r tbl-humanstats, echo=FALSE, warning=FALSE, message=FALSE}
